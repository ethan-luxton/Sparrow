            ...
            try {
                const response = await client.responses.create({
                    ...
                    input: [
                        {
                            role: 'system',
                            content: 'For user queries, you must perform a web_search at least once unless the query is strictly about yourself ' +
                                'or is simple arithmetic. Prefer fresh, authoritative sources. Keep response concise.',
                        },
                        { role: 'user', content: args.query },
                        {
                            role: 'system',
                            content: `After searching, summarize in 3-5 sentences, then list 3-5 sources with title + URL. ` +
