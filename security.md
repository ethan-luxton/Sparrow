...
- Paths: Any path-like argument must resolve within either the current working directory or ~/.pixeltrail.
...
- Scope: path must be within allowed roots (cwd or ~/.pixeltrail).
...
- Storage: index saved in ~/.pixeltrail/doc_index.json.
...
- Scope: Restricted to ~/.pixeltrail by default.
